...
# 2. Definir los parámetros para controlar la complejidad
# Esto es lo MÁS IMPORTANTE. Evita que el modelo memorice.
param_dist = {
    # 'n_estimators': Cuántos árboles (más es mejor, pero más lento)
    'n_estimators': randint(100, 400),
    
    # 'max_depth': ¡CLAVE! Qué tan profundo puede ser cada árbol.
    # Controla el sobreajuste.
    'max_depth': [3, 4, 5, 7, 10, None], 
    
    # 'min_samples_leaf': ¡CLAVE! Mínimo de muestras para crear una hoja.
    # Fuerza al modelo a generalizar.
    'min_samples_leaf': [3, 5, 10, 15]
}

# 3. Configurar la Búsqueda (RandomizedSearchCV)
# n_iter=75 probará 75 combinaciones aleatorias. Es rápido y efectivo.
