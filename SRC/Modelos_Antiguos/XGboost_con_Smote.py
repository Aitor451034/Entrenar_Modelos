...
# ==============================================================================
print("Iniciando búsqueda de hiperparámetros para SMOTE + XGBoost...")
...
modelo_rf = XGBClassifier(random_state=42,eval_metric='logloss',scale_pos_weight=ratio_desbalanceo)
...
param_grid_xgb = {
    ...
    # 'max_depth': Profundidad. XGBoost suele usar árboles más cortos
    'model__max_depth': [3, 4, 5],
    # 'learning_rate': ¡CLAVE! Qué tan rápido aprende el modelo
    'model__learning_rate': [0.01, 0.05, 0.1],
    # 'subsample': Fracción de datos usados para cada árbol (controla sobreajuste)
    'model__subsample': [0.7, 1.0],
    # 'colsample_bytree': Fracción de características usadas para cada árbol (como max_features)
